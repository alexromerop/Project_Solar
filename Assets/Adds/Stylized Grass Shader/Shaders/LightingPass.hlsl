...
#endif
{
	...
	//return float4(BoundsEdgeMask(GetBendMapUV(inputData.positionWS) - 0.5).xxx, 1.0);
	#endif
	...
	ApplyTranslucency(color, inputData.viewDirectionWS, mainLight, translucencyMask);
