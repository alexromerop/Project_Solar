...
namespace StylizedGrass
{
    ...
    public class MaterialUI : ShaderGUI
    {
        ...
        private void ApplyChanges()
        {
            ...
            if (targetMat.HasProperty("_SpecularHighlights")) CoreUtils.SetKeyword(targetMat, "_SPECULARHIGHLIGHTS_OFF", targetMat.GetFloat("_SpecularHighlights") == 0.0f);
            ...
            if (targetMat.HasProperty("_DisableBending")) CoreUtils.SetKeyword(targetMat, "_DISABLE_BENDING", targetMat.GetFloat("_DisableBending") == 1.0f);
